...
def move_mobile_robot():
    ...
    while dist_to_go - dist_x > 0.05:
        ...
        desired_speed = 0.2 / (np.exp(-12 * last_dist + 6) + 1) + 0.1
...
def move_mobile_robot_ang():
    ...
    dist_to_go = (2 / (math.cos(dist_to_rotate / 2))) / 2

    ratio_lin_and_ang = dist_to_go / dist_to_rotate

    while abs(dist_to_go - dist_x) > 0.1 and abs(dist_to_rotate - dist_ang) > 0.01:
        ...
        desired_ang_speed = (desired_speed / ratio_lin_and_ang) * 0.725
